...
export function loadPyodide(config: any): Promise<{
    globals: import("./pyproxy.gen.js.js").PyProxy;
    FS: any;
    pyodide_py: import("./pyproxy.gen.js.js").PyProxy;
    version: string;
    loadPackage: typeof loadPackage;
    loadPackagesFromImports: typeof import("./api.js.js").loadPackagesFromImports;
    loadedPackages: any;
    isPyProxy: typeof import("./pyproxy.gen.js.js").isPyProxy;
    runPython: typeof import("./api.js.js").runPython;
    runPythonAsync: typeof import("./api.js.js").runPythonAsync;
    registerJsModule: typeof registerJsModule;
    unregisterJsModule: typeof import("./api.js.js").unregisterJsModule;
    setInterruptBuffer: typeof import("./api.js.js").setInterruptBuffer;
    checkInterrupt: typeof import("./api.js.js").checkInterrupt;
    toPy: typeof import("./api.js.js").toPy;
    pyimport: typeof import("./api.js.js").pyimport;
    unpackArchive: typeof import("./api.js.js").unpackArchive;
    registerComlink: typeof import("./api.js.js").registerComlink;
    PythonError: typeof import("./api.js.js").PythonError;
    PyBuffer: typeof import("./pyproxy.gen.js.js").PyBuffer;
}>;
...
import { loadPackage } from "./load-pyodide.js.js";
import { registerJsModule } from "./api.js.js";
